...
function SellerCartScreen(props) {
  ...
  const onCheckout = () => {
    ...
    getApi.postData('seller/placeOrder', sendData).then(response => {
  ...
  const applyCouponCode = () => {
    ...
    if (couponCode != null) {
      ...
      getApi.postData('seller/applyCoupon', sendData).then(response => {
  ...
  const onDeleteItem = id => {
    ...
    logfunction('Sample requrest  ', sendData);
    getApi.postData('seller/deleteCart', sendData).then(response => {
      logfunction('response response  ', response);
  ...
  const decrement = (id, productID, quantity) => {
    ...
    logfunction('Sample requrest  ', sendData);
    getApi.postData('seller/updateCart', sendData).then(response => {
      logfunction('response response  ', response);
  ...
  const calculateCart = () => {
    getApi.getData('seller/getCart', []).then(response => {
...
export default connect(mapStateToProps, mapDispatchToProps)(SellerCartScreen);
